...
/// </summary>
    public class Plugin
    {
        ...
        internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, Plugin value, string baseUrl)
        {
            if("upsertPlugin" == operationId)
            {
                var message = new HttpRequestMessage(HttpMethod.Put, baseUrl + "/v1/plugins");
            ...
            throw new ArgumentException($"Attempt to build HttpRequestMessage for invalid operationId [{operationId}] for request type [Plugin]");
        }
    }
}