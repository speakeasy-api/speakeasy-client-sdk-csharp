...
Organization req = new Organization() {
    AccountType = SpeakeasySDK.Models.Shared.AccountType.ScaleUp,
    CreatedAt = System.DateTime.Parse("2023-12-01T17:06:07.804Z"),
    Id = "<id>",
    Name = "<value>",
    Slug = "<value>",
    TelemetryDisabled = false,
    UpdatedAt = System.DateTime.Parse("2023-04-03T12:48:32.253Z"),
};
