...
namespace SpeakeasySDK
{
    ...
    public interface IEvents
    {
        ...
        /// Load targets for a particular workspace
        /// </summary>
        Task<GetWorkspaceTargetsDeprecatedResponse> GetTargetsDeprecatedAsync(GetWorkspaceTargetsDeprecatedRequest request);
        ...
        /// </summary>
        Task<SearchWorkspaceEventsResponse> SearchAsync(SearchWorkspaceEventsRequest request);
    }
    ...
    public class Events: IEvents
    {
        ...
        public async Task<GetWorkspaceTargetsDeprecatedResponse> GetTargetsDeprecatedAsync(GetWorkspaceTargetsDeprecatedRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
        ...
        public async Task<SearchWorkspaceEventsResponse> SearchAsync(SearchWorkspaceEventsRequest request)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/v1/workspace/{workspace_id}/events", request);
