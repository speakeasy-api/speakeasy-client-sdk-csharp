...
namespace SpeakeasySDK
{
    ...
    public class Suggest: ISuggest
    {
        ...
        public async Task<SuggestResponse> SuggestAsync(SuggestRequest request)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "suggest", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<SuggestItemsResponse> SuggestItemsAsync(SuggestItemsRequestBody request)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "suggestItems", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<SuggestOpenAPIResponse> SuggestOpenAPIAsync(SuggestOpenAPIRequest request)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "suggestOpenAPI", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<SuggestOpenAPIRegistryResponse> SuggestOpenAPIRegistryAsync(SuggestOpenAPIRegistryRequest request)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "suggestOpenAPIRegistry", new List<string> {  }, SDKConfiguration.SecuritySource);
