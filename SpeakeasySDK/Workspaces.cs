...
namespace SpeakeasySDK
{
    ...
    public interface IWorkspaces
    {
        ...
        /// </summary>
        Task<GetWorkspaceFeatureFlagsResponse> GetWorkspaceFeatureFlagsAsync(GetWorkspaceFeatureFlagsRequest request);
    }
    ...
    public class Workspaces: IWorkspaces
    {
        ...
        public async Task<GetWorkspaceFeatureFlagsResponse> GetWorkspaceFeatureFlagsAsync(GetWorkspaceFeatureFlagsRequest request)
        {
            if (request == null)
            {
