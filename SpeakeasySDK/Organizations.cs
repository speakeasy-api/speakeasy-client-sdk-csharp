    ...
    public class Organizations: IOrganizations
    {
        ...
        public async Task<GetOrganizationsResponse> GetOrganizationsAsync()
        {
            ...
            if((response.StatusCode == 200))
            {
                ...
                {
                    response.Organizations = JsonConvert.DeserializeObject<List<Organization>>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumConverter(), new AnyDeserializer() }});
                }
