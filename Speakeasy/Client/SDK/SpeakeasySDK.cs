...
namespace Speakeasy.Client.SDK
{
    ...
    public class SpeakeasySDK: ISpeakeasySDK
    {
        ...
        public SpeakeasySDK(Security? security = null, Func<Security>? securitySource = null, string? workspaceID = null, SDKConfig.Server? server = null, string? serverUrl = null, Dictionary<string, string>? urlParams = null, ISpeakeasyHttpClient? client = null, RetryConfig? retryConfig = null)
        {
            if (server != null)
            {
              _server = server;
